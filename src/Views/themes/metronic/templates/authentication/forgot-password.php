            ...
            <div class="login-content d-flex flex-column pt-lg-0 pt-12">
                ...
                <div class="login-form">
                    ...
                    <div class="form-group fv-plugins-icon-container">
                        <input class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" type="email" placeholder="Email" name="email" autocomplete="off" kl_vkbd_parsed="true">
                        <div class="fv-plugins-message-container"></div>
                    </div>
                    <!--end::Form group-->
                    <!--begin::Form group-->
                    <div class="form-group d-flex flex-wrap">
                        <button type="submit" id="kt_login_forgot_form_submit_button" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-4"><?= lang('Auth.valider') ?></button>
                        <a href="/<?= CI_AREA_ADMIN; ?>" id="kt_login_forgot_" class="btn btn-light-primary font-weight-bolder font-size-h6 px-8 py-4 my-3"><?= lang('Auth.cancel') ?></a>
                    </div>
                    <!--end::Form group-->
