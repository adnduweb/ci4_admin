    ...
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__group" id="kt_subheader_search">
                ...
                <span class="kt_subheader_total">0</span> <?= lang('Core.total'); ?> </span>
            ...
            <div class="kt-subheader__group kt-hidden" id="kt_subheader_group_actions">
                <div class="kt-subheader__desc"><span id="kt_subheader_group_selected_rows"></span> <?= lang('Core.selected'); ?>:</div>
        ...
        <div class="kt-subheader__toolbar">
            ...
            <a href="/<?= env('CI_AREA_ADMIN'); ?>/<?= $_company_id; ?>/settings-advanced/roles/add" class="btn btn-label-brand btn-bold">
            <?= lang('Core.add_group'); ?> </a>
        </div>
    </div>
</div>
