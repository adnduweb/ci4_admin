<!-- <div class="row">
    ...
    <div class="col-lg-9 col-xl-6">
        <h3 class="kt-section__title kt-section__title-sm"><?= ucfirst(lang('Core.info_general')); ?>:</h3>
    </div>
</div> -->
...
<div class="form-group form-group-sm row">
    ...
    <div class="col-lg-9 col-xl-6">
    <select required name="global[setting_env]" class="form-control selectpicker file kt-selectpicker" data-actions-box="true" title="<?= ucfirst(lang('Core.choose_one_of_the_following')); ?>"  id="setting_env">
