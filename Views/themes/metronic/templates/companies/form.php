...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
	...
	<?= form_open('', ['id' => 'kt_apps_companies_form', 'class' => 'kt-form kt_apps_company_form', 'novalidate' => false]); ?>
								...
								<div class="kt-form kt-form--label-right">
									<div class="kt-form__body">
										<div class="kt-section kt-section--first">
											...
											<?= $this->include('Adnduweb\Ci4Admin\themes\metronic\templates\companies\__form_section\general') ?>
											</div>
										</div>
									</div>
								</div>
