...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
	...
	<input type="hidden" name="controller" value="AdminGroupController" />
			...
			<div class="flex-row ">
				<div class="card card-custom py-5 px-5">
					<ul class="nav nav-tabs nav-tabs-line mb-5" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#kt_user_permission_group_tab_1" role="tab">
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								...
								</svg> <?= lang('Core.tab_permission_group'); ?>
							</a>
						</li>
					</ul>
								...
								<div class="kt-form__body">
									<div class="kt-section kt-section--first">
										<div class="kt-section__body">
											<?= $this->include('/admin/themes/metronic/controllers/roles/__form_section/general') ?>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="kt-section kt-section--first">
										<div class="kt-section__body">
											<?php if (isset($form->id)) { ?>
												...
												<?php } else {  ?>
													<?= $this->include('/admin/themes/metronic/controllers/roles/__form_section/permissions') ?>
												<?php }  ?>
											<?php } else { ?>
												<div class="alert alert-elevate alert-light alert-bold" role="alert">
