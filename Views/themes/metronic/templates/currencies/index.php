...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
    <?= $this->include('Adnduweb\Ci4Admin\themes\metronic\templates\currencies\kt_list_toolbar') ?>
            ...
            <div class="flex-row ">
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-body px-0">
                        <!--begin: Datatable -->
                        <div class="datatable datatable-bordered datatable-head-custom" id="kt_apps_currency_list_datatable"></div>
                    </div>
                    <!--end: Datatable -->
                </div>
            </div>
