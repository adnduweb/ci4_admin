                    ...
                    <ul class="nav nav-tabs nav-tabs-line mb-5" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#kt_user_edit_tab_1" role="tab">
                                ...
                                </svg> <?= ucfirst(lang('Core.tab_general')); ?>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_4" role="tab">
                                ...
                                </svg> <?= ucfirst(lang('Core.tab_security')); ?>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_5" role="tab">
                                ...
                                </svg> <?= ucfirst(lang('Core.tab_front')); ?>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#kt_analitycs_rgpd" role="tab">
                                ...
                                </svg> <?= ucfirst(lang('Core.tab_analitycs_rgpd')); ?>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_6" role="tab">
                                ...
                                </svg> <?= ucfirst(lang('Core.tab_email')); ?>
                            </a>
                        </li>
                        <?php if (inGroups(1, user()->id)) { ?>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_7" role="tab">
                                    ...
                                    </svg> <?= ucfirst(lang('Core.tab_language')); ?>
                                </a>
                            </li>
                        <?php } ?>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_8" role="tab">
                                ...
                                </svg> <?= ucfirst(lang('Core.tab_image')); ?>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_9" role="tab">
                                ...
                                </svg> <?= ucfirst(lang('Core.tab_ecommerce')); ?>
                            </a>
                        </li>
                        <?php if (inGroups(1, user()->id)) { ?>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_10" role="tab">
                                    ...
                                    </svg> <?= ucfirst(lang('Core.tab_command')); ?>
                                </a>
                            </li>
                        <?php } ?>
                    </ul>
                                ...
                                <div class="kt-form__body">
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            <?= $this->include('/admin/themes/metronic/controllers/settings/__form_section/general') ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="kt_user_edit_tab_4" role="tabpanel">
                            <div class="kt-form kt-form--label-right">
                                <div class="kt-form__body">
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            <?= $this->include('/admin/themes/metronic/controllers/settings/__form_section/security') ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="kt_user_edit_tab_5" role="tabpanel">
                            <div class="kt-form kt-form--label-right">
                                <div class="kt-form__body">
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            <?= $this->include('/admin/themes/metronic/controllers/settings/__form_section/front') ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="kt_analitycs_rgpd" role="tabpanel">
                            <div class="kt-form kt-form--label-right">
                                <div class="kt-form__body">
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            <?= $this->include('/admin/themes/metronic/controllers/settings/__form_section/analitycs_rgpd') ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="kt_user_edit_tab_6" role="tabpanel">
                            <div class="kt-form kt-form--label-right">
                                <div class="kt-form__body">
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            <?= $this->include('/admin/themes/metronic/controllers/settings/__form_section/email') ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane" id="kt_user_edit_tab_7" role="tabpanel">
                                <div class="kt-form kt-form--label-right">
                                    <div class="kt-form__body">
                                        <div class="kt-section kt-section--first">
                                            <div class="kt-section__body">
                                                <?= $this->include('/admin/themes/metronic/controllers/settings/__form_section/language') ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane" id="kt_user_edit_tab_8" role="tabpanel">
                            <div class="kt-form kt-form--label-right">
                                <div class="kt-form__body">
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            <?= $this->include('/admin/themes/metronic/controllers/settings/__form_section/images') ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="kt_user_edit_tab_9" role="tabpanel">
                            <div class="kt-form kt-form--label-right">
                                <div class="kt-form__body">
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            <?= $this->include('/admin/themes/metronic/controllers/settings/__form_section/ecommerce') ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="kt_user_edit_tab_10" role="tabpanel">
                            <div class="kt-form kt-form--label-right">
                                <div class="kt-form__body">
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            <?= $this->include('/admin/themes/metronic/controllers/settings/__form_section/command') ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
