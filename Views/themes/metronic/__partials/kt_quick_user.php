        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    <div class="symbol-label symbol-text"> <?= user()->firstname[0]; ?> <?= user()->lastname[1]; ?></div>
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="navi mt-2">
                        ...
                        <a href="/<?= CI_AREA_ADMIN; ?>/logout" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5"><?= lang('Core.sign_out'); ?></a>
                    </div>
                </div>
            </div>
            <!--end::Header-->
            ...
            <?= ''; //$this->include('/admin/themes/metronic/__partials/notifications/quick_notifications.php') 
            ?>
        </div>
        <!--end::Content-->
    </div>
