...
class Install extends BaseCommand
{
    ...
    protected $name        = 'adnduweb:install';
    ...
    public function run(array $params)
    {
        ...
        try {
            ...
            Install::replaceInfile('database.default.hostname = "127.0.0.1"', 'database.default.hostname = "' . $hostname . '"');
            Install::replaceInfile('database.default.database = ""', 'database.default.database = "' . $database . '"');
            Install::replaceInfile('database.default.username = ""', 'database.default.username = "' . $username . '"');
            Install::replaceInfile('database.default.password = ""', 'database.default.password = "' . $password . '"');
            Install::replaceInfile('database.default.DBPrefix = ""', 'database.default.DBPrefix = "' . $DBPrefix . '"');
            Install::replaceInfile('database.default.port = ', 'database.default.port = ' . $port);
        } catch (\Exception $e) {
            $this->showError($e);
        }
        ...
        try {
            Install::replaceInfile('app.nameApp = ""', 'app.nameApp = "' . $name . '"');
            Install::replaceInfile('app.baseURL = "https://www.exemple.com"', 'app.baseURL = "' . $url . '"');
            Install::replaceInfile('CI_SITE_AREA = ""', 'CI_SITE_AREA = "' . $CI_SITE_AREA . '"');
        } catch (\Exception $e) {
            $this->showError($e);
        }
